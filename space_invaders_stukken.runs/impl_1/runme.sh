...
HD_PWD='C:/Users/warre/Desktop/school/dsd/space_invaders_stukken/space_invaders_stukken.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source space_invaders.tcl -notrace
