...
HD_PWD='C:/Users/warre/Desktop/school/dsd/space_invaders_stukken/space_invaders_stukken.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log space_invaders.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source space_invaders.tcl
